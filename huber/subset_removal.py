...
typical_samples = original_indices[sorted_indices[4000:]]  # 其余 4000 个样本

# 保存这些索引，用于后续操作
torch.save(non_typical_samples, 'non_typical_samples.pth')
torch.save(typical_samples, 'typical_samples.pth')
